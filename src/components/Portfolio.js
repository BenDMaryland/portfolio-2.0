    ...
    return (
        ...
        <Portfol id="portfolio" onMouseEnter={() => scrollHander("portfolio")}  >
            ...
            <div className='all_projects'>
                ...
                <article onMouseEnter={(e) => focusHandler(e)} onMouseLeave={(e) => focusHandler(e)} className='project_container'>
                    <div className='overlay'>      <img className="profile_image" alt='Agile solutions' src={agile} /> </div>
                    {showLinks ?
                ...
                <article className='project_container'>
                    ...
                    <img className="profile_image" alt='Agile solutions' src={sudoku} />

                </article>

                <article className='project_container'>

                    <img className="profile_image" alt='Agile solutions' src={tick} />

                </article>

                <article className='project_container'>

                    <img className="profile_image" alt='Agile solutions' src={agile} />
